...
export default function Footer() {
  ...
  return (
    <footer className="w-full bg-[#EBEBE8] border-t border-hairline py-14 sm:py-20 md:py-28 text-basalt">
      <div className="max-w-6xl mx-auto px-4 sm:px-8 lg:px-12 text-center space-y-10 sm:space-y-16">
        ...
        <div className="space-y-3 sm:space-y-4 max-w-xl mx-auto">
          <div className="flex items-center justify-center gap-2.5 sm:gap-3">
            ...
            <span className="text-[9px] sm:text-[10px] tracking-widest uppercase font-mono-spec bg-white text-stone-600 px-2.5 py-1 rounded-full border border-hairline shadow-2xs">
        ...
        <nav className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-10 md:gap-14 text-sm sm:text-base font-medium font-sans">
          <Link
            href="/about"
        ...
        {/* Roomy Bottom Bar */}
        <div className="pt-8 sm:pt-12 border-t border-hairline/80 flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4 text-xs font-mono-spec text-stone-500">
          <div>
